document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById('finalize-purchase').addEventListener('click', function (event) {
    ...
    // Limpiar el carrito y subtotal del localStorage
    localStorage.removeItem('subtotal'); // Eliminar el subtotal
    localStorage.removeItem('cartItems'); // Eliminar los productos del carrito (usa el nombre que le diste al carrito)

    // Mostrar el mensaje de éxito
    function showSuccessMessageAndRedirect() {
        const successMessage = document.getElementById('success-message');
        successMessage.style.display = 'flex'; // Mostrar el popup
        setTimeout(() => {
