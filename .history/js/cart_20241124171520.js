document.addEventListener("DOMContentLoaded", function() {
    ...
    function renderCart() {
        ...
        // Usamos currency que es el campo correcto en tu JSON
        const moneda = cartItems.length > 0 ? cartItems[0].currency : 'USD'; // Valor por defecto 'USD' en caso de que el carrito esté vacío.

        cartItems.forEach((producto, index) => {
            const { name, currency, price, image, quantity } = producto;
