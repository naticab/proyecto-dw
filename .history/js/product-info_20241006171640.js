...
function renderStars(value) {
    ...
    for (let i = 0; i < 5; i++) {
        if (i < Math.floor(value)) {
            starsHtml += '<i class="fa fa-star checked"></i>'; // Estrella llena
        } else if (i < value) {
            starsHtml += '<i class="fa fa-star fa-star-half-alt checked"></i>'; // Estrella media
        } else {
            starsHtml += '<i class="fa fa-star"></i>'; // Estrella vacía
        }
    }
    return starsHtml;
}
