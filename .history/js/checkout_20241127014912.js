...
function clearCart() {
  localStorage.removeItem('cart'); // Asumiendo que los productos están almacenados bajo la clave 'cart'
  localStorage.removeItem('subtotal'); // También eliminamos el subtotal
}

// Modificar la parte donde se completa la compra
document.getElementById('finalize-purchase').addEventListener('click', function (event) {
  ...
  // Si todo es válido, vaciar el carrito y mostrar el mensaje de éxito
  clearCart();
